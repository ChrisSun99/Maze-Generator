...
public class Maze {
    ...
    private static final String[] GENERATION_METHODS = {"DFS", "BinaryTreeGen","BiDFSGen", "Cellular Automata", "PrimGen", "KruskalGen"};

    private static final String[] SOLVING_METHODS = {"Bi-directional DFS", "CASolve"};
    ...
    private void createAndShowGUI() {
        ...
        JSlider initialSpeedSlider = new JSlider(JSlider.HORIZONTAL, 1, 1500, 1);
        JSlider genSpeedSlider = new JSlider(JSlider.HORIZONTAL, 1, 1500, 1);
        JSlider solveSpeedSlider = new JSlider(JSlider.HORIZONTAL, 1, 1500, 1);

        Hashtable<Integer, JLabel> labels = new Hashtable<Integer, JLabel>();
        labels.put(1, new JLabel("Fast"));
        labels.put(1500, new JLabel("Slow"));
...
//        c.gridx = 1;
//        c.gridy = 2;
        card1.add(stepButton, c);

        card2.add(solveButton, c);
        c.gridx = 1;
        c.gridy = 2;
        card2.add(stopButton, c);
        ...
        stopButton.addActionListener(event -> createAndShowGUI());
